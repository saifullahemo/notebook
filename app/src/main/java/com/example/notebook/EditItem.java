    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (i < MainActivity.getCat().size()) {
            if (categorie.equals(MainActivity.getCat().get(i).getName())) {
                ...
                ((LinearLayout) findViewById(R.id.textBar1)).setBackgroundColor(MainActivity.getCat().get(i).getColor());
    ...
    public void addItemsOnSpinner2() {
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ((LinearLayout) findViewById(R.id.textBar1)).setBackgroundColor(MainActivity.getCat().get(position).getColor());
